...
<head>
   ...
   <!-- Title Of Site -->
   <title>한반도 뽀개기 - 나의 여행 노트 달력</title>
                     ...
                     <div class="container">
                        <div class="inner-bottom">
                           <ul class="user-header-menu">
                              <li class="active"><a>나의 여행달력</a></li>
               ...
               <div class="row">
                     ...
                     <aside class="sidebar-wrapper pr-5 pr-0-xs">
                        ...
                        <div class="common-menu-wrapper">
                           ...
                           <ul class="common-menu-list">
								...
								<li class="active"><a href="/guide-detail-offer.html">나의 여행달력</a></li>
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9 mt-20">
                     ...
                     <div class="dashboard-wrapper">
                        ...
                        <div>
                           <input type = "hidden" id="userIdImsi" value="<%= user.getUsersId() %>"/>
                        </div>
                        <!-- End calendar -->

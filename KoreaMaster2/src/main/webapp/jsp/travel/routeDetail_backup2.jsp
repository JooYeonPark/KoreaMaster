							...
							<div class="col-xs-12 col-sm-12 col-md-8">
								<div class="content-wrapper">
									...
									<div id="detail-content-sticky-nav-01">
										...
										<!-- ì¬í ì¤ëª : ë¬¸ì¥ì¼ë¡ END -->

										<div class="bt mt-30 mb-30"></div>

										<!-- ì¬íì ì¼ì, ëì ë± ì¤ëª   START -->
										...
										<!-- ì¬íì ì¼ì, ëì ë± ì¤ëª   END -->

										<div class="mb-25"></div>
										<div class="bb"></div>
										<div class="mb-25"></div>

										<!-- ì¬í íë§ ìì´ì½ì¼ë¡ START -->
										<div class="featured-icon-simple-wrapper">
									...
									<div id="detail-content-sticky-nav-03">
										...
										<div class="itinerary-toggle-wrapper mb-40">
											<div class="panel-group bootstrap-toggle">
												...
												<!-- ì²«ì§¸ë  START : ëë¨¸ì§ë ì´ê±° ë³µë¶í´ì£¼ì¸ì~ -->
												<div class="panel">
													<!-- ì²«ì§¸ë  í° ì¼ì  ë³´ì¬ì£¼ë div START  -->
													...
													<!-- ì²«ì§¸ë  í° ì¼ì  ë³´ì¬ì£¼ë div END  -->

													<!-- ì²«ì§¸ë  ìì¸ì¼ì  ë³´ì¬ì£¼ë dic START -->
													<div id="bootstarp-toggle-one-2"
														class="panel-collapse collapse">
														<div class="panel-body">
														<!-- ì¼ì  ë³´ì¬ì£¼ë ui START -->
